...
export const bioData: Record<string, BioData> = {
  "geoffrey-hinton": {
    id: "geoffrey-hinton", name: "Geoffrey Hinton", role: "Professor Emeritus", company: "Deep Learning Pioneer", era: "Cloud & AI", nationality: "British-Canadian", born: "December 6, 1947",
    ...
    relatedIds: ["yoshua-bengio", "yann-lecun", "sam-altman"],
  },
  "yoshua-bengio": {
    id: "yoshua-bengio", name: "Yoshua Bengio", role: "Professor", company: "Mila / Université de Montréal", era: "Cloud & AI", nationality: "Canadian", born: "March 5, 1964",
    ...
    relatedIds: ["yann-lecun", "geoffrey-hinton", "demis-hassabis"],
  },
  "andrej-karpathy": {
    id: "andrej-karpathy", name: "Andrej Karpathy", role: "AI Researcher", company: "Tesla AI / OpenAI", era: "The Frontier", nationality: "Slovak-Canadian", born: "October 23, 1986",
    ...
    relatedIds: ["sam-altman", "demis-hassabis", "elon-musk"],
  },
  "noam-shazeer": {
    id: "noam-shazeer", name: "Noam Shazeer", role: "Co-founder & CEO", company: "Character.AI", era: "The Frontier", nationality: "American", born: "1976",
    ...
    relatedIds: ["sam-altman", "demis-hassabis", "ilya-sutskever"],
  },
  "ilya-sutskever": {
    id: "ilya-sutskever", name: "Ilya Sutskever", role: "Co-founder", company: "SSI / OpenAI", era: "The Frontier", nationality: "Russian-Canadian-Israeli", born: "1986",
    ...
    milestones: [{ year: "1986", event: "Born" }],
    relatedIds: ["sam-altman", "demis-hassabis", "dario-daniela-amodei"],
  },
  "meg-whitman": {
    id: "meg-whitman", name: "Meg Whitman", role: "CEO", company: "eBay / HP", era: "The Dot-Com Boom", nationality: "American", born: "August 4, 1956",
    ...
    relatedIds: ["sheryl-sandberg", "pierre-omidyar", "mark-zuckerberg"],
  },
  "marissa-mayer": {
    id: "marissa-mayer", name: "Marissa Mayer", role: "CEO", company: "Yahoo / Google", era: "Mobile & Social", nationality: "American", born: "May 30, 1975",
    ...
    relatedIds: ["sheryl-sandberg", "mark-zuckerberg", "meg-whitman"],
  },
  "safra-catz": {
    id: "safra-catz", name: "Safra Catz", role: "CEO", company: "Oracle", era: "Cloud & AI", nationality: "Israeli-American", born: "December 1, 1961",
    ...
    relatedIds: ["bill-gates", "satya-nadella", "ginni-rometty"],
  },
  "ginni-rometty": {
    id: "ginni-rometty", name: "Ginni Rometty", role: "CEO", company: "IBM", era: "Cloud & AI", nationality: "American", born: "July 29, 1957",
    ...
    relatedIds: ["safra-catz", "satya-nadella", "ursula-burns"],
  },
  "ursula-burns": {
    id: "ursula-burns", name: "Ursula Burns", role: "CEO", company: "Xerox", era: "The Personal Computer", nationality: "American", born: "September 20, 1958",
    ...
    relatedIds: ["ginni-rometty", "sheryl-sandberg", "grace-hopper"],
  },
};

export function getBioById(id: string): BioData | undefined {
  return bioData[id];
}